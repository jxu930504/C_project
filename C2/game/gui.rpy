...
## 顏色用於未填充的條形部分。這些顏色不直接使用，而是在重新生成條形影像檔案時使
## 用
...
## 用於遊戲內文字的字形
define gui.text_font = gui.preference("font", "Cubic_11.ttf")

## 用於角色名稱的字形
define gui.name_text_font = gui.preference("font", "Cubic_11.ttf")

## 用於遊戲外文字的字形
define gui.interface_text_font = gui.preference("font", "Cubic_11.ttf")
...
## 對話角色的名字相對於文字框的位置。這些可以是從左側或頂端開始的整數像素，也可
## 以是到中心的 0.5 個像素
...
## 對話相對於文字框的位置。這些可以是相對於文字方塊左側或頂端的整數像素，或相對
## 於中心的 0.5 個像素
...
## 這些變數會覆寫不同類型按鈕的設定。請參閱 gui 文件以了解可用按鈕的類型以及每個
## 按鈕的用途
##
## 預設介面使用這些自訂設定：
...
## Ren'Py 將顯示的 NVL 模式條目的最大數量。當要顯示的條目多於此時，最舊的條目將被刪除。
define gui.nvl_list_length = 200

## NVL 模式條目的高度。將其設為 None 以使條目動態調整高度
define gui.nvl_height = None

## 當 gui.nvl_height 為 None 時 NVL 模式條目之間的間距，以及 NVL 模式條目和選單之間的間距
define gui.nvl_spacing = 8

## 給予對話角色名稱的標籤的位置、寬度和對齊方式
define gui.nvl_name_xpos = 20
define gui.nvl_name_ypos = 0
define gui.nvl_name_width = 100 #要改
define gui.nvl_name_xalign = 0.0

## 對話文字的位置、寬度和對齊方式
define gui.nvl_text_xpos = 70
define gui.nvl_text_ypos = 0
define gui.nvl_text_width = 1450 #要改
define gui.nvl_text_xalign = 0.0

## nvl_thought 文字的位置、寬度和對齊方式（由 nvl_narrator 字元表示的文字）
define gui.nvl_thought_xpos = 70
define gui.nvl_thought_ypos = 0
define gui.nvl_thought_width = 1450
define gui.nvl_thought_xalign = 0.0

## nvl menu_buttons 的位置
define gui.nvl_button_xpos = 24
...
## www.renpy.org/doc/html/style_properties.html#style-property-language 中找到財
## 產語言
